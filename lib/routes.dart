...
import 'package:trading/app/app.dart' deferred as app;
import 'package:trading/app/routes.dart' as app_routes;
import 'package:trading/deferred_widget.dart';
...
class RouteConfiguration {
  /// List of [Path] for route matching. When a named route is pushed with
  ...
  static List<Path> paths = [
    Path(
      r'^' + app_routes.homeRoute,
      (context, match) => StudyWrapper(
        study: DeferredWidget(app.loadLibrary,
            () => app.TradingApp()), // ignore: prefer_const_constructors
      ),
