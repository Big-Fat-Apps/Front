...
class OperationData {
  OperationData({this.isPurchase, this.operationText, this.sumOfDeal, this.date});

  final bool? isPurchase;

  final double? sumOfDeal;
...
class GameHistoryData {
  GameHistoryData({this.gameDate, this.numberOfParticipants, this.place, this.income});
...
class DummyDataService {
  ...
  static List<String> getSettingsTitles(BuildContext context) {
    final localizations = TradingLocalizations.of(context)!;
    return <String>[
      localizations.rallySettingsTheme,
      localizations.rallySettingsTextScale,
      localizations.rallySettingsTextDirection,
      localizations.rallySettingsLocale,
      localizations.rallySettingsAbout,
      localizations.rallySettingsFeedback,
  ...
  static List<OperationData> getOperations(BuildContext context) {
    final localizations = TradingLocalizations.of(context)!;
    return <OperationData>[
      OperationData(isPurchase: true,
        operationText: true? localizations.rallyOperationHistoryPurchase:
        localizations.rallyOperationHistorySale,
        sumOfDeal: 100, date: '18.09.2002', ),
      OperationData(isPurchase: false,
        operationText: false? localizations.rallyOperationHistoryPurchase:
        localizations.rallyOperationHistorySale,
        sumOfDeal: 100, date: '18.09.2002', ),
    ];
  }

  static List<GameHistoryData> getGameHistory(BuildContext context) {
    return <GameHistoryData>[
      GameHistoryData(gameDate: '19.12.2022', numberOfParticipants: 100, place: 1, income: 15.30),
      GameHistoryData(gameDate: '20.12.2022', numberOfParticipants: 130, place: 10,income: 1.00),
      GameHistoryData(gameDate: '21.12.2022', numberOfParticipants: 1123, place: 13, income: -3.50)
    ];
  }
}
