...
class TradingColors {
  ...
  static const Color gray = Color(0xFF000000);
  static const Color gray60 = Color(0xFF000000);
  static const Color gray25 = Color(0xFFFFFFFF);
  static const Color white60 = Color(0xFF000000);
  static const Color primaryBackground = Color(0xFFF6F8FB);
  static const Color inputBackground = Color(0xFFF6F8FB);
  static const Color cardBackground = Color(0x03FEFEFE);
  static const Color buttonColor = Color(0xFFFC5055);
