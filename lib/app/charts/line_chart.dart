...
class TradingLineChart extends StatelessWidget {
  const TradingLineChart({
    super.key,
  ...
  Widget build(BuildContext context) {
    return CustomPaint(
      painter: TradingLineChartPainter(
...
class TradingLineChartPainter extends CustomPainter {
  TradingLineChartPainter({
  ...
  void _drawLine(Canvas canvas, Rect rect) {
    final linePaint = Paint()
      ..color = TradingColors.accountColor(2)
