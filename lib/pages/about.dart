...
class _AboutDialog extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final bodyTextStyle =
        textTheme.bodyMedium!.apply(color: colorScheme.onPrimary);
    final localizations = TradingLocalizations.of(context)!;

    const name = 'TraderUnknown\'s Battlegrounds'; // Don't need to localize.
    const legalese = '© 2022 Big Fat Apps'; // Don't need to localize.
