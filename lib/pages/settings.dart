...
import 'package:trading/pages/home.dart';
import 'package:trading/pages/settings_list_item.dart';
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  LinkedHashMap<Locale, DisplayOption> _getLocaleOptions() {
    var localeOptions = LinkedHashMap.of({
      systemLocaleOption: DisplayOption(
        TradingLocalizations.of(context)!.settingsSystemDefault +
            (deviceLocale != null
    ...
    var supportedLocales =
        List<Locale>.from(TradingLocalizations.supportedLocales);
  ...
  Widget build(BuildContext context) {
    ...
    final settingsListItems = [
      ...
      ToggleSetting(
        text: TradingLocalizations.of(context)!.settingsSlowMotion,
...
class SettingsAbout extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SettingsLink(
      title: TradingLocalizations.of(context)!.settingsAbout,
...
class SettingsFeedback extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return _SettingsLink(
      title: TradingLocalizations.of(context)!.settingsFeedback,
      icon: Icons.feedback,
      onTap: () async {
        final url =
    ...
    return MergeSemantics(
      child: Padding(
        ...
        child: SelectableText(
          TradingLocalizations.of(context)!.settingsAttribution,
